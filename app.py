...
pusher = Pusher(app_id=u'1084359', key=u'b0444e132a855890c46f', secret=u'4c2ba0e5eaa928e2f42c', cluster=u'ap2')
...
def getAnalyticsData():
   ...
   # userIP = "192.168.28.1" if request.remote_addr == '127.0.0.1' else request.remote_addr #anzal
    userIP = "192.168.1.107" if request.remote_addr == '127.0.0.1' else request.remote_addr #samiksha
  #  userIP = "192.168.56.1" if request.remote_addr == '127.0.0.1' else request.remote_addr #vishvesh
